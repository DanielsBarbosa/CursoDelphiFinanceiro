...
{$IFDEF USEHINTMANAGER}
  sHintManager,
{$ENDIF}   
  sToolBar, sColorSelect, sDialogs, sCurrencyEdit, sSpinEdit, sRadioButton,
  ...
  sFrameBar, acShellCtrls, acCoolBar, acProgressBar, acNotebook, acAlphaHints, acHeaderControl,
  acMagn, acPageScroller,
{$IFNDEF BCB}   
{$IFDEF DELPHI7UP}   
  acWebBrowser,
{$ENDIF}  
...
{$IFNDEF ALITE}
  ...
  RegisterComponents('AlphaAdditional', [
    ...
    {$IFNDEF BCB}{$IFDEF DELPHI7UP}, TsWebBrowser{$ENDIF}{$ENDIF}]);
