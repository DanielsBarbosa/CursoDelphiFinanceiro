...
{$ENDIF}
  ...
  sNoHotEdits : TsCodes = [COC_TsSpinEdit..COC_TsComboBoxEx, COC_TsDBEdit..COC_TsDBGrid, COC_TsCustomComboEdit..COC_TsDateEdit, COC_TsAdapterEdit];
