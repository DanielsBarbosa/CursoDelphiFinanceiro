...
// (DO NOT EDIT: machine generated header) 'acAlphaImageList.pas' rev: 22.00
...
private:
	typedef System::DynamicArray<Graphics::TBitmap*> _TsVirtualImageList__1;
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE bool __fastcall GetImageFormat(const System::UnicodeString FileName, TsImageFormat &ImageFormat)/* overload */;
...
extern PACKAGE bool __fastcall AddImageFromRes(unsigned aInstance, TsAlphaImageList* ImageList, const System::UnicodeString ResName, TsImageFormat aImageFormat);
