...
// (DO NOT EDIT: machine generated header) 'sCheckListBox.pas' rev: 22.00
...
protected:
	...
	virtual void __fastcall LoadRecreateItems(Classes::TStrings* RecreateItems);
	virtual void __fastcall SaveRecreateItems(Classes::TStrings* RecreateItems);
