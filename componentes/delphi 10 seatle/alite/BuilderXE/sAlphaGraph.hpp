...
extern PACKAGE void __fastcall SetAPixel(const Graphics::TBitmap* Bmp, int x, int y, const Sconst::TsColor Value);
...
extern PACKAGE void __fastcall WriteText32(const Graphics::TBitmap* Bmp, System::WideChar * Text, bool Enabled, Types::TRect &aRect, unsigned Flags, int SkinIndex, bool Hot, System::TObject* SkinManager = (System::TObject*)(0x0), bool IsAnsi = false);
...
extern PACKAGE void __fastcall DrawSmallSkinRect(Graphics::TBitmap* Bmp, const Types::TRect &R, const Sconst::TCacheInfo &ci, const Smaskdata::TsMaskData &MaskData, int State);
extern PACKAGE void __fastcall DrawSkinRect(Graphics::TBitmap* Bmp, const Types::TRect &R, const Sconst::TCacheInfo &ci, const Smaskdata::TsMaskData &MaskData, const int State, const bool UpdateCorners);
extern PACKAGE void __fastcall CopyMasterRect(const Types::TRect &R1, const Types::TRect &R2, const Graphics::TBitmap* Bmp, const Sconst::TCacheInfo &CI, const Smaskdata::TsMaskData &MaskData);
...
extern PACKAGE void __fastcall BlendGlyphByMask(const Types::TRect &R1, const Types::TRect &R2, Graphics::TBitmap* Bmp1, Graphics::TBitmap* Bmp2, int AddedTransparency, const Smaskdata::TsMaskData &MaskData);
...
extern PACKAGE void __fastcall PaintItem32(int SkinIndex, bool Filling, int State, const Types::TRect &R, const Types::TPoint &pP, Graphics::TBitmap* ItemBmp, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
extern PACKAGE void __fastcall PaintItemBG32(int SkinIndex, int State, const Types::TRect &R, Graphics::TBitmap* ItemBmp, System::TObject* SkinManager, Graphics::TColor CustomColor = (Graphics::TColor)(0xff00ff));
extern PACKAGE void __fastcall DrawSkinRect32(Graphics::TBitmap* Bmp, const Types::TRect &R, const Sconst::TCacheInfo &ci, const Smaskdata::TsMaskData &MaskData, const int State);
extern PACKAGE void __fastcall DrawSkinRect32Ex(Graphics::TBitmap* Bmp, const Types::TRect &R, const Sconst::TCacheInfo &ci, const Smaskdata::TsMaskData &MaskData, const int State, const Types::TRect &MaxWidths, int Opacity);
