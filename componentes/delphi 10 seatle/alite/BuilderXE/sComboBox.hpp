...
// (DO NOT EDIT: machine generated header) 'sComboBox.pas' rev: 22.00
...
__published:
	...
	__property Classes::TVerticalAlignment VerticalAlignment = {read=FVerticalAlignment, write=SetVerticalAlignment, nodefault};
	__property TextHint;
	__property Touch;
