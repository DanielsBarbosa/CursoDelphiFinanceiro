...
// (DO NOT EDIT: machine generated header) 'acSBUtils.pas' rev: 22.00
...
public:
	...
	virtual void __fastcall SetSkinParams(void);
	virtual void __fastcall RestoreStdParams(void);
	Types::TRect __fastcall ClientRect(void);
public:
...
public:
	__fastcall virtual TacTreeViewWnd(HWND AHandle, Scommondata::TsCommonData* ASkinData, Sskinmanager::TsSkinManager* ASkinManager, const TacSkinParams &SkinParams, bool Repaint);
	virtual void __fastcall acWndProc(Messages::TMessage &Message);
	virtual void __fastcall SetSkinParams(void);
	virtual void __fastcall RestoreStdParams(void);
...
//-- var, const, procedure ---------------------------------------------------
static const System::ShortInt SM_BTNSIZE = 0x0;
static const System::ShortInt SM_SCROLLWIDTH = 0x1;
static const System::ShortInt TopOffset = 0x4;
static const System::ShortInt BottomOffset = 0x2;
static const System::ShortInt LeftOffset = 0x1;
static const System::ShortInt RightOffset = 0x1;
