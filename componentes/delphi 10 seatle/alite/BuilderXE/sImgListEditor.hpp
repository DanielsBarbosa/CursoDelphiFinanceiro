...
// (DO NOT EDIT: machine generated header) 'sImgListEditor.pas' rev: 22.00
...
__published:
	...
	void __fastcall ListView1KeyDown(System::TObject* Sender, System::Word &Key, Classes::TShiftState Shift);
