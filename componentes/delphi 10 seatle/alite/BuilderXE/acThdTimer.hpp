...
// (DO NOT EDIT: machine generated header) 'acThdTimer.pas' rev: 22.00
...
public:
	/* TThread.Create */ inline __fastcall TacTimerThread(void)/* overload */ : Classes::TThread() { }
...
//-- var, const, procedure ---------------------------------------------------
static const System::ShortInt TT_GLOWING = 0x1;
