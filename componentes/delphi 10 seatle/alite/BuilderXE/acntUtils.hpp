...
// (DO NOT EDIT: machine generated header) 'acntUtils.pas' rev: 22.00
...
extern PACKAGE Messages::TMessage __fastcall MakeMessage(const int Msg, const int WParam, const int LParam, const int aResult);
...
extern PACKAGE int __fastcall iffi(const bool L, const int i1, const int i2);
...
extern PACKAGE Sconst::TCacheInfo __fastcall MakeCacheInfo(const Graphics::TBitmap* Bmp, const int x = 0x0, const int y = 0x0);
