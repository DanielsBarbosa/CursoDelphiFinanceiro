...
extern PACKAGE void __fastcall CopyImage(const Graphics::TBitmap* Glyph, const Imglist::TCustomImageList* ImageList, const int Index);
...
extern PACKAGE void __fastcall PaintItemBGFast(int SkinIndex, int BGIndex, int BGHotIndex, const System::UnicodeString SkinSection, const Sconst::TCacheInfo &ci, int State, const Types::TRect &R, const Types::TPoint &pP, Graphics::TBitmap* ItemBmp, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
...
extern PACKAGE int __fastcall PaintSection(const Graphics::TBitmap* Bmp, System::UnicodeString Section, const System::UnicodeString SecondSection, const int State, const System::TObject* Manager, const Types::TPoint &ParentOffset, const Graphics::TColor BGColor, HDC ParentDC = (HDC)(0x0));
...
extern PACKAGE BOOL __fastcall acGetTextExtent(const HDC DC, const System::UnicodeString Str, tagSIZE &Size);
...
extern PACKAGE void __fastcall BlendTransBitmap(Graphics::TBitmap* Bmp, double Blend, const Sconst::TsColor Color);
...
extern PACKAGE bool __fastcall LoadJpegOrBmp(Graphics::TPicture* Image, const System::UnicodeString FileName, bool Gray);
