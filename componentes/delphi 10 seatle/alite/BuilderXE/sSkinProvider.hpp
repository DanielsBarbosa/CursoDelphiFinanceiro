...
// (DO NOT EDIT: machine generated header) 'sSkinProvider.pas' rev: 22.00
...
typedef void __fastcall (__closure *TAddItemEvent)(Classes::TComponent* Item, bool &CanBeAdded, System::UnicodeString &SkinSection);
...
__published:
	__property int AdditionalHeight = {read=FAdditionalHeight, write=SetAdditionalHeight, nodefault};
public:
...
private:
	...
	Sskinmanager::ThirdPartyList* FThirdParty;
...
protected:
	...
	void __fastcall AC_WMNCRButtonDown(Messages::TMessage &Message);
	...
	Types::TPoint __fastcall FormLeftTop(void);
	...
	void __fastcall SendOwnerToBack(void);
...
public:
	...
	void __fastcall CaptFormPaintDC(HDC aDC);
...
__published:
	...
	__property Sskinmanager::ThirdPartyList* ThirdParty = {read=FThirdParty, write=FThirdParty};
...
public:
	...
	bool __fastcall IsControlSupported(Classes::TComponent* Control);
	...
	void __fastcall AddNewItem(const Controls::TWinControl* Ctrl, const System::UnicodeString SkinSection)/* overload */;
...
//-- var, const, procedure ---------------------------------------------------
static const System::ShortInt FS_SIZING = 0x1;
static const System::Byte FS_BLENDMOVING = 0x80;
static const System::Word FS_ANIMMINIMIZING = 0x100;
static const System::Word FS_ANIMCLOSING = 0x200;
static const System::Word FS_ANIMRESTORING = 0x400;
static const System::Word FS_THUMBDRAWING = 0x800;
static const System::Word FS_CHANGING = 0x1000;
static const System::Word FS_MAXHEIGHT = 0x2000;
static const System::Word FS_MAXWIDTH = 0x4000;
static const System::Word FS_ACTIVATE = 0x8000;
...
static const System::ShortInt ScrollWidth = 0x12;
static const System::ShortInt IconicHeight = 0x1a;
static const System::Word HTUDBTN = 0x3e8;
...
extern PACKAGE void __fastcall FinishBlendOnMoving(TsSkinProvider* sp, Forms::TForm* CoverForm = (Forms::TForm*)(0x0));
...
extern PACKAGE int __fastcall SysCaptHeight(Forms::TForm* Form);
...
extern PACKAGE void __fastcall UpdateProviderThirdNames(TsSkinProvider* sm);
